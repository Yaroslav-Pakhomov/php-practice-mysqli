...
INSERT INTO `example_users` (`id`, `user_name`, `city_id`, `son_id`) VALUES
	(1, 'Пользователь 1', 1, 2),
	(2, 'Пользователь 2', 1, 3),
	(3, 'Пользователь 3', 1, 4),
	(4, 'Пользователь 4', 2, 5),
	(5, 'Пользователь 5', 2, 6),
	(6, 'Пользователь 6', 2, 7),
	(7, 'Пользователь 7', 3, 8),
	(8, 'Пользователь 8', 3, 9),
	(9, 'Пользователь 9', 3, NULL);
...
-- Дамп данных таблицы db_organization.example_users_shop: ~8 rows (приблизительно)
...
-- Дамп данных таблицы db_organization.product_products_parameter: ~9 rows (приблизительно)
